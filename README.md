# Spellcheck [![Build Status](https://travis-ci.org/hpi-swa-teaching/SpellChecking.svg?branch=spellcheck-package)](https://travis-ci.org/hpi-swa-teaching/SpellChecking) [![Coverage Status](https://coveralls.io/repos/github/hpi-swa-teaching/SpellChecking/badge.svg?branch=spellcheck-package)](https://coveralls.io/github/hpi-swa-teaching/SpellChecking?branch=spellcheck-package)
...
Metacello new   
    baseline: 'Spellcheck';  
    repository: 'github://hpi-swa-teaching/SpellChecking:spellcheck-package/packages';  
    load: 'tests'.
```    
