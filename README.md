# Spellcheck [![Build Status](https://travis-ci.org/hpi-swa-teaching/SpellChecking.svg?branch=download-more-dictionaries)](https://travis-ci.org/hpi-swa-teaching/SpellChecking) [![Coverage Status](https://coveralls.io/repos/github/hpi-swa-teaching/SpellChecking/badge.svg?branch=download-more-dictionaries)](https://coveralls.io/github/hpi-swa-teaching/SpellChecking?branch=download-more-dictionaries)
...
Metacello new   
    baseline: 'Spellcheck';  
    repository: 'github://hpi-swa-teaching/SpellChecking:download-more-dictionaries/packages';  
    load: 'tests'.
```    
